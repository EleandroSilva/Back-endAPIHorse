...
type
  TEntidadeUnidadeProduto<T : iInterface> = class(TInterfacedObject, iEntidadeUnidadeProduto<T>)
    ...
    public
      ...
      function IdEmpresa(Value : Integer) : iEntidadeUnidadeProduto<T>; overload;
...
function TEntidadeUnidadeProduto<T>.IdEmpresa(Value: Integer): iEntidadeUnidadeProduto<T>;
begin
  Result := Self;
  FIdEmpresa := Value;
end;

function TEntidadeUnidadeProduto<T>.IdEmpresa: Integer;
begin
  Result := FIdEmpresa;
end;

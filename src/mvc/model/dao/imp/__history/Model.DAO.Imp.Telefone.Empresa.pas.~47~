...
begin
  ...
  try
   ...
   begin
     FTelefoneEmpresa.Id(FDataSet.FieldByName('te.id').AsInteger);
     QuantidadeRegistro;
   end else FTelefoneEmpresa.Id(0);
  end;
end;

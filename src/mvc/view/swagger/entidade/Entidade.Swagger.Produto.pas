...
type
  TProduto = class
    private
      ...
      FValorVendaPromocional : Currency;{decimal(10,4) Not Null 'Usar esta coluna quanto o estabelecimento queira fazer preço promocional'}
    ...
    public
      ...
      [SwagProp('Código do produto vender por unidade Unique Key',True)]
      property ceantrib            : String   read FCeanTrib            write FCeanTrib;
      [SwagProp('Código do produto quando vende por fardo(Caso não tenha, este código será igual o ceanTrib), Unique Key',True)]
      ...
      [SwagProp('Caso não quiser informar, então precha com (ZERO-0)', True)]
      ...
      [SwagProp('Preencher com valor mínimo de 0,01)', True)]
      ...
      [SwagProp('Produto importado então informe 3,4ou 5=Não foi importado 1,2,6 ou 7', True)]
      ...
      [SwagProp('Caso pertencer a balança informe 1 caso contrário 0 ', True)]

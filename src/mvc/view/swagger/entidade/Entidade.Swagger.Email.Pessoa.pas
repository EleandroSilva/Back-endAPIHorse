...
{*******************************************************}
unit Entidade.Swagger.Email.Pessoa;
...
type
  TEmailPessoa = class
    ...
    public
      ...
      [SwagProp('Foreign Key->Tabela (emailpessoa<-Idempresa=id->Tabela empresa)) Excluír=Cascade; Alterar=Cascade', True)]
      property idempresa : Integer read FIdEmpresa write FIdEmpresa;
      [SwagProp('Foreign Key->Tabela (emailpessoa<-Idempresa=id->Tabela pessoa)) Excluír=Cascade; Alterar=Cascade', True)]
